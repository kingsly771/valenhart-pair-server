...
app.post('/api/pair', async (req, res) => {
    ...
    // Wipe any partial/corrupted session before fresh pairing
...
async function runPairing(phone) {
    ...
    try {
        ...
        // ── Pairing code: exactly like original index.js ──────────────────────
        // Must be OUTSIDE connection.update, called right after socket creation
